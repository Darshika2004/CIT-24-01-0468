...
![Task 1.1](screenshots/Task%201.1%20Screenshot.png)

### Part 2: Pod Deployment
- Created and tested the initial frontend pod using `pod-frontend.yaml`.
![Task 2.1](screenshots/task2.1%20Screenshot.png)

### Part 3: Self-Healing with Deployments
- Observed Kubernetes self-healing behavior before and after deleting a pod.
- **Before Deleting Pod:**
![Task 3.1 Before](screenshots/Task%203.1%20Before%20screenshot.png)
- **After Deleting Pod (Self-Healed):**
![Task 3.1 After](screenshots/Task%203.1%20After%20screenshot.png)

### Part 4: Scaling
- Scaled frontend replicas up to 5 and down to 2 using `kubectl scale`.
- **Before Scale:**
![Task 4.1 Before](screenshots/Task%204.1%20Before%20screenshot.png)
- **Scale Up to 5:**
![Task 4.1 Scale Up](screenshots/Task%204.1%20After%20scale%20up%20screenshot.png)
- **Scale Down to 2:**
![Task 4.1 Scale Down](screenshots/Task%204.1%20After%20scale%20down%20screenshot.png)

### Part 5: Exposing Services
- Exposed frontend via NodePort service and accessed via browser using `minikube service`.
![Task 5.1](screenshots/Task%205.1%20screenshot.png)
